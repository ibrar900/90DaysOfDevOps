...
What I learned:
1. File aging and filtering: Learned how to use find with -mmtime to filter files by age
2. Compression: Practice using gzip and tar to compress logs and backups
3. Taking backupsof folders with time stamps
4. Writing cron jobs
